...
- (void)viewDidLoad
{
    ...
    self.headerImageView = [[UIImageView alloc] initWithImage: [UIImage imageNamed: @"PPTHeader" inBundle: [NSBundle bundleForClass: [self class]] compatibleWithTraitCollection:nil]];
